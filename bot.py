...
from jobs.parser_job import check_sites, send_notifications_for_sites_checking, check_free_vps, CHAT_ID
...
async def post_init(application: Application) -> None:
    ...
    time_to_check_birthdays = datetime.time(hour=2, minute=0, second=0)
    ...
    application.job_queue.run_daily(check_birthdays, time_to_check_birthdays)
